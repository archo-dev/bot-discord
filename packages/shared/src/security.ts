...
export const PANEL_MUTATION_POLICIES: readonly PanelMutationPolicy[] = [
  ...
  { method: "POST", path: "/api/guilds/:guildId/sanctions", capability: "moderation_write", allowed: ADMIN },
  { method: "POST", path: "/api/guilds/:guildId/sanctions/:id/revoke", capability: "moderation_write", allowed: ADMIN },
  { method: "PATCH", path: "/api/guilds/:guildId/warnings/:warnId", capability: "moderation_write", allowed: ADMIN },
  { method: "PUT", path: "/api/guilds/:guildId/sanction-exemptions", capability: "moderation_write", allowed: ADMIN },
