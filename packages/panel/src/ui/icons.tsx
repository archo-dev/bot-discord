...
export const Icon = {
  ...
  panel: () => svg(<><rect x="3" y="3" width="18" height="18" rx="2" /><path d="M8 3v18M8 9h13" /></>),
  sliders: () =>
  ...
  workflow: () => svg(<><circle cx="6" cy="5" r="2" /><circle cx="18" cy="12" r="2" /><circle cx="6" cy="19" r="2" /><path d="M8 5h3a3 3 0 0 1 3 3v1a3 3 0 0 0 3 3" /><path d="M8 19h3a3 3 0 0 0 3-3v-1a3 3 0 0 1 3-3" /></>),
  ...
  pulse: () => svg(<><path d="M3 12h4l2-7 4 14 2-7h6" /><circle cx="12" cy="12" r="10" opacity=".2" /></>),
  message: () => svg(<><path d="M21 15a4 4 0 0 1-4 4H8l-5 3V7a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4z" /><line x1="8" y1="9" x2="16" y2="9" /><line x1="8" y1="13" x2="13" y2="13" /></>),
  alert: () => svg(<><path d="M10.3 3.7 2.6 17a2 2 0 0 0 1.7 3h15.4a2 2 0 0 0 1.7-3L13.7 3.7a2 2 0 0 0-3.4 0z" /><line x1="12" y1="9" x2="12" y2="13" /><line x1="12" y1="17" x2="12.01" y2="17" /></>),
  calendar: () => svg(<><rect x="3" y="5" width="18" height="16" rx="2" /><line x1="16" y1="3" x2="16" y2="7" /><line x1="8" y1="3" x2="8" y2="7" /><line x1="3" y1="10" x2="21" y2="10" /></>),
  refresh: () => svg(<><path d="M20 7v5h-5" /><path d="M4 17v-5h5" /><path d="M6.1 9a7 7 0 0 1 11.7-2.6L20 9" /><path d="m4 15 2.2 2.6A7 7 0 0 0 17.9 15" /></>),
