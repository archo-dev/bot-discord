...
/*
 * Corps de la vitrine (hero + modules + réassurance), extrait de Landing en M2.
 * Réutilisé tel quel par :
 *   - Landing (page autonome, chemin flag-off / 401) — chrome propre (header/footer) ;
 *   - la home publique sous PublicLayout (flag `platform.publicSite` ON).
 * Rendu identique dans les deux cas ; aucune logique métier.
 */
