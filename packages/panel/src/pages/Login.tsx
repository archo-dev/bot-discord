export function Login() {
  return (
    <div className="flex min-h-screen items-center justify-center p-4">
      <div className="w-full max-w-sm rounded-2xl border border-zinc-800 bg-zinc-900 p-6 text-center shadow-lg sm:p-8">
        ...
        <h1 className="text-2xl font-bold tracking-tight">Bot Admin Panel</h1>
        <p className="mt-2 text-sm text-zinc-400">
          Gérez la modération, les commandes et la musique de votre serveur.
        </p>
        <a
          href="/auth/login"
          className="mt-6 inline-flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-indigo-600 font-semibold text-white transition hover:bg-indigo-500"
        >
