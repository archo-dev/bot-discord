  ...
  },
  {
    ...
    items: [
      { to: "automod", label: "Auto-mod", icon: "shield", subtitle: "Filtres automatiques : spam, invitations, liens et mots interdits." },
      {
        ...
        label: "Modération",
        icon: "gavel",
        subtitle: "Historique unifié, application des sanctions et activité vocale au même endroit.",
        paths: ["sanctions", "apply", "modlog", "voicelog"],
        tabs: [
          { to: "sanctions", label: "Historique" },
          { to: "apply", label: "Appliquer une sanction" },
