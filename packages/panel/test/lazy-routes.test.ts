...
const lazyRoutes: Array<{ path: string; load: () => Promise<Record<string, unknown>>; name: string }> = [
  ...
  { path: "Automations", name: "AutomationsPage", load: () => import("../src/pages/Automations.js") },
  { path: "AutomationEditor", name: "AutomationEditorPage", load: () => import("../src/pages/AutomationEditor.js") },
  { path: "Sanctions", name: "ModerationHistoryPage", load: () => import("../src/pages/Sanctions.js") },
  { path: "Sanctions", name: "ApplySanctionPage", load: () => import("../src/pages/Sanctions.js") },
