...
M01 à M09 sont implémentées selon les statuts détaillés ci-dessous. M09 « tickets d'équipe » provient de `milestone/team-tickets` et utilise la migration additive `0030_team_tickets.sql`. M10 et les cinq éléments de backlog restent validés au niveau produit, sans autorisation implicite d’implémentation.
